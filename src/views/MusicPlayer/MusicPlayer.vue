...
<template>
  <div class="music-player-container">
    ...
    <!-- MusicPlayerCard 音乐播放器主体 -->
    <main class="music-player-card-container">
      <!-- Card -->
      <div class="music-player-card">
        ...
        <div class="card-right">
          ...
          <div class="album-info">
            <p class="album-name">Norm Ender</p>
            <p class="album-singer">Mekanin Sahibi</p>
          </div>
          <!-- 控制栏 -->
    ...
    .music-player-card {
      ...
      .card-left {
        ...
        .album-cover {
          ...
          width: 6rem;
          border-radius: 1rem;
          box-shadow: -2px 2px 10px 2px $album-box-shadow;
          background: url('@/assets/musicCover/cover-1.jpg') center / cover;
          transition: all 0.2s ease-in-out;
          &:hover {
            transform: translate(0, -1rem) scale(1.1);
            box-shadow: 0px 4px 40px $album-box-shadow;
          }
